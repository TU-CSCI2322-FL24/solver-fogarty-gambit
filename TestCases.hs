...
mateInTwoRookGame = (0, White, [(('A',3), White, Pawn False), (('H',2), White, Pawn False), (('A',5), White, Rook True), (('C',2), White, King True), 
...
mateInOneQueenGame = (0, White, [(('A',2), White, Pawn False), (('B',2), White, Pawn False), (('C',2), White, Pawn False), (('F',2), White, Pawn False), (('G',2), White, Pawn False), (('H',2), White, Pawn False),(('A',1), White, Rook False), (('H',1), White, Rook False),(('E',1), White, King False), (('C',3), White, Knight), (('C',4), White, Bishop),(('C',1), White, Bishop),(('F',3), White, Queen), 
...
mateInTwoKnightQueenGame = (0, White, [(('A',2), White, Pawn False), (('B',2), White, Pawn False), (('E',5), White, Pawn False), (('F',4), White, Pawn False), (('G',2), White, Pawn False), (('H',2), White, Pawn False),(('A',1), White, Rook False), (('F',1), White, Rook True),(('H',1), White, King True), (('G',4), White, Knight), (('H',4), White, Queen), 
...
mateInThreeQueenGame = (0, White, [(('A',2), White, Pawn False), (('B',2), White, Pawn False), (('C',2), White, Pawn False), (('F',2), White, Pawn False), (('F',6), White, Pawn False),(('G',2), White, Pawn False), (('H',2), White, Pawn False),(('A',1), White, Rook False), (('H',1), White, Rook False),(('E',1), White, King False), (('F',3), White, Queen), 
...
pawnUpGame :: Game
pawnUpGame = (0, White, [(('A',4), White, Pawn False), (('B',3), White, Pawn False), (('C',4), White, Pawn False), (('D',5), White, Pawn False), (('F',2), White, Pawn False), (('G',2), White, Pawn False), (('H',3), White, Pawn False), (('D',1), White, Rook True), (('H',1), White, King True),
...
queenCheckWinsRookGame = (0, Black, [(('A',3), White, Pawn False), (('B',2), White, Pawn False), (('C',2), White, Pawn False), (('E',3), White, Pawn False), (('F',5), White, Pawn False), (('G',4), White, Pawn False),(('G',1), White, Rook True), (('C',1), White, King True), (('E',2), White, Queen),
...
hangingRookGame = (0, Black, [(('B',2), White, Pawn False), (('F',2), White, Pawn False), (('G',3), White, Pawn False), (('E',6), White, Rook True), (('C',1), White, King False), (('F',5), White, Bishop), 
